	...
	<div id="list-cart">
		...
		<form>
			<table class="table table-bordered .table-responsive text-center">
				...
				<tr>
					<td><img height="150px"class="img-responsive" src="{{asset('storage/app/avatar/'.$item->options->image)}}"></td>
					<td>{{$item->name}}</td>
					<td>
					...
					<td><span class="price">{{number_format($item->price*$item->qty,0,',','.')}}VND</span></td>
		...
		<div id="xac-nhan">
			...
			<form method="POST" action="{{asset('complete')}}">
				<div class="form-group">
