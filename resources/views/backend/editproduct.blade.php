						...
						<div class="row" style="margin-bottom:40px">
							<div class="col-xs-8">
								...
								<div class="form-group" >
									...
									<img id="avatar" class="thumbnail" width="300px" src="{{asset('storage/app/avatar/'.$product->prod_image)}}">
								</div>
								<div class="form-group" >
								...
								<div class="form-group" >
									<label>Miêu tả</label>
									<textarea class="ckeditor" required name="description" value="{{$product->prod_discription}}"></textarea>
								...
								<div class="form-group" >
									...
									<select required name="cate" class="form-control">
										@foreach($catelist as $item)
											<option value="{{$item->cate_id}} @if($item->cate_id==$product->id) @endif">{{$item->cate_name}}</option>
										@endforeach
									</select>
								</div>
								<div class="form-group" >
									<label>Sản phẩm nổi bật</label><br>
									Có: <input type="radio" name="featured" value="1" @if($product->prod_feature==1) selected @endif>
									Không: <input type="radio" checked name="featured" value="0" @if($product->prod_feature==0) selected @endif>
								</div>
