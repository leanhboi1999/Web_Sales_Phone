...
<head>
	...
	<title> Shop Di Động - <?php echo $__env->yieldContent('title'); ?></title>
...
<body>    
	...
	<header id="header">
		<div class="login">
		<a class="display" href="<?php echo e(asset('login')); ?>">Log in</a>
		</div>
		...
		<div class="container">
			<div class="row">
				<div id="logo" class="col-md-2 col-sm-12 col-xs-12">
					<h1>
						<a href="<?php echo e(asset('/')); ?>"><img src="img/home/logofpt.png" height="60px"></a>						
				...
				<div id="search" class="col-md-6 col-sm-12 col-xs-12">
					<form action="<?php echo e(asset('search/')); ?>" method="GET">
				...
				<div id="signup" class="col-md-2 col-sm-12 col-xs-12">
					<a class="display" href="<?php echo e(asset('register')); ?>">Sign up</a>									    
				</div>
			</div>			
		</div>
	</header><!-- /header -->
				...
				<div id="sidebar" class="col-md-3">
					<nav id="menu">
						<ul>
                            ...
                            <li class="menu-item"><a href="<?php echo e(asset('category/'.$item->cate_id)); ?>" title=""><?php echo e($item->cate_name); ?></a></li>
