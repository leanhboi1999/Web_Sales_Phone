						...
						<div class="row" style="margin-bottom:40px">
							<div class="col-xs-8">
								...
								<div class="form-group" >
									...
									<input required type="number" name="price" class="form-control"value="<?php echo e($product->prod_price); ?>">
								</div>
								<div class="form-group" >
									<label>Ảnh sản phẩm</label>
									<input id="img" type="file" name="img" class="form-control hidden" onchange="changeImg(this)">
									<img id="avatar" class="thumbnail" width="300px" src="<?php echo e(asset('storage/app/avatar/'.$product->prod_image)); ?>">
								</div>
								<div class="form-group" >
								...
								<div class="form-group" >
									<label>Miêu tả</label>
									<textarea class="ckeditor" required name="description" value="<?php echo e($product->prod_discription); ?>"></textarea>
								...
								<div class="form-group" >
									...
									<select required name="cate" class="form-control">
										<?php $__currentLoopData = $catelist; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											<option value="<?php echo e($item->cate_id); ?> <?php if($item->cate_id==$product->id): ?> <?php endif; ?>"><?php echo e($item->cate_name); ?></option>
										<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
									</select>
								</div>
								<div class="form-group" >
									<label>Sản phẩm nổi bật</label><br>
									Có: <input type="radio" name="featured" value="1" <?php if($product->prod_feature==1): ?> selected <?php endif; ?>>
									Không: <input type="radio" checked name="featured" value="0" <?php if($product->prod_feature==0): ?> selected <?php endif; ?>>
								</div>
